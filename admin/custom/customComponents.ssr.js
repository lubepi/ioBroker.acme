  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__ConfigCustomAcmeSet__customComponents_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    const initRes = runtimeInit({
      name: "__mfe_internal__ConfigCustomAcmeSet",
      remotes: [],
      shared: {},
    });
    const initToken = { from: "__mfe_internal__ConfigCustomAcmeSet" };
